...
# mock.patch のドットパス解決のため、親モジュールに子属性を設定
sys.modules["src"].tools = sys.modules["src.tools"]
sys.modules["src.tools"].external = sys.modules["src.tools.external"]
